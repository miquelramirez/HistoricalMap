        ...
        try:            
            ...
            for i in range(d):
                ...
                try:
                    ...
                    QgsMessageLog.logMessage("Problem reading band {} from image {}".format(i, inImage))
                ...
                try:
                    ...
                    QgsMessageLog.logMessage("Cannot save band {} on image {}".format(i, outName))
        ...
        try:
            ...
            try:
                ...
                try:    
                    ...
                    QgsMessageLog.logMessage("Cannot train with Classifier {}".format(inClassifier))
    ...
    def initPredict(self,inRaster,inModel):
        ...
        try:
            ...
            if model is None:
                ...
                QgsMessageLog.logMessage("Model: {} is none".format(inModel))
            else:
                tree,M,m = pickle.load(model)
                model.close()
        except:
            QgsMessageLog.logMessage("Error while loading the model : {}".format(inModel))
        ...
        try:
            ...
            QgsMessageLog.logMessage("Cannot create temp file {}".format(rasterTemp))
            # Process the data
        try:
            predictedImage = self.predict_image(inRaster, rasterTemp, tree, None, -10000, SCALE=[M, m])
            
        except:
            QgsMessageLog.logMessage("Problem while predicting {} in temp {}".format(inRaster, rasterTemp))
